package com.whl.bigdata.web_click_mr_hive.mr;
...
import com.whl.bigdata.web_click_mr_hive.mrbean.PageViewsBean;
import com.whl.bigdata.web_click_mr_hive.mrbean.VisitBean;

/**
 * 从pageviews模型结果数据中进一步梳理出visit模型 sessionid start-time out-time start-page
 * out-page pagecounts ......
 * 
 * @author
 *
...
public class ClickStreamVisit {
	...
	static class ClickStreamVisitMapper extends Mapper<LongWritable, Text, Text, PageViewsBean> {
		...
		protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			...
			// (String session, String remote_addr, String timestr, String
			// request, int step, String staylong, String referal, String
			// useragent, String bytes_send, String status)
			...
			pvBean.set(fields[0], fields[1], fields[2], fields[3], fields[4], step, fields[6], fields[7], fields[8],
					fields[9]);
