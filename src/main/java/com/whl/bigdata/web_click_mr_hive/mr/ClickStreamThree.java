...
import com.whl.bigdata.web_click_mr_hive.mrbean.WebLogBean;
				...
				for (int i = 0; i < beans.size(); i++) {
					...
					if (timeDiff < 30 * 60 * 1000) {
						...
						v.set(session + "\001" + key.toString() + "\001" + beans.get(i - 1).getRemote_user() + "\001"
								...
								+ step + "\001" + (timeDiff / 1000) + "\001" + beans.get(i - 1).getHttp_referer()
								+ "\001" + beans.get(i - 1).getHttp_user_agent() + "\001"
